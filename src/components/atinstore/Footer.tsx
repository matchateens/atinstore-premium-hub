      ...
      <div className="grid md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/75">
            ...
            <li className="flex items-center gap-2"><Instagram className="h-4 w-4" /> @tinspedia</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4" /> hello@tinspedia.id</li>
          </ul>
        </div>
      </div>
